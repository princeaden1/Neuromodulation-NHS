...
if (isset($_POST['create_neuro'])) {
    ...
    if (
        ...
        $verify_email = "SELECT COUNT(*) FROM Patients WHERE email = :email";
        ...
        if ($email_in_use) {
            ...
            try {
                $sql = "INSERT INTO Patients (first_name, last_name, email, date_of_birth, ratingScore) VALUES (:first_name, :last_name, :email, :date_of_birth, :ratingScore)";
                ...
                $painSql = "INSERT INTO PatientPainDetails (patient_id, pain_clinic_rating, pain_worst_rating, pain_least_rating, pain_average_rating, pain_right_now_rating, effect_on_activity, effect_on_mood, effect_on_walking, effect_on_work, effect_on_people, effect_on_sleep, effect_on_enjoyment) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                echo "<script>toastr.success('Record Successfully Added');</script>";
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="last_name" placeholder="Surname" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" max="<?php echo date('Y-m-d'); ?>" placeholder="Date of Birth" required>
                            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="pain_worst_rating" name="pain_worst_rating" min="0" max="10" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="pain_least_rating" name="pain_least_rating" min="0" max="10" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="pain_average_rating" name="pain_average_rating" min="0" max="10" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="pain_right_now_rating" name="pain_right_now_rating" min="0" max="10" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="effect_on_activity" name="effect_on_activity" min="0" max="10" onfocusout="calculate_total_score()" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="effect_on_mood" name="effect_on_mood" min="0" max="10" onfocusout="calculate_total_score()" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="effect_on_walking" name="effect_on_walking" min="0" max="10" onfocusout="calculate_total_score()" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="effect_on_work" name="effect_on_work" min="0" max="10" onfocusout="calculate_total_score()" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="effect_on_people" name="effect_on_people" min="0" max="10" onfocusout="calculate_total_score()" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="effect_on_sleep" name="effect_on_sleep" min="0" max="10" onfocusout="calculate_total_score()" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="effect_on_enjoyment" name="effect_on_enjoyment" min="0" max="10" onfocusout="calculate_total_score()" required>
                        </div>
                    </div>
                </div>

                <div class="card mb-3">
                    <div class="card-header bg-green" id="see_total">Total: 0</div>
                </div>

                <div>
                    <input type="hidden" class="btn btn-success" name="create_neuro" value="Create">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#neuro_form').on('submit', function(e) {
                ...
                $.ajax({
                    url: 'index.php', // URL to the PHP script
                    type: 'POST',
                    data: $(this).serialize(), // Serialize the form data
                    success: function(response) {
                        $(" #notification").html(response);
                        if (response.includes("Successful")) {
                            $('#neuro_form')[0].reset(); //Form will reset after successful submission
                        }
                    },
